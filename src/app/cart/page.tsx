...
// const CartPage = () => {
//   const [products, setProducts] = useState<Product[]>([]); // State to store all products from Sanity
...
//         <p className="text-gray-600">Add some products to your cart and come back!</p>
//       </div>
//     );
//   }
...
//           const product = products.find((p) => p._id === cartItem.id); // Match cart item with product data
...
//                 {product && (
//                   <Image
//                     src={urlFor(product.productImage).url()} // Use the Sanity image URL
//                     alt={product.title}
//                     width={80}
//                     height={80}
