...
// import { Button } from "@/components/ui/button";
// import { Menu, UserCircle } from "lucide-react"; // Import Menu and UserCircle icons
// import { useSelector } from "react-redux";
// import { RootState } from "@/app/store/store";
// import { useUser, UserButton } from "@clerk/nextjs"; // Import Clerk hooks and components
...
//     <main>
//       {/* Header Container */}
//       <div className="top-0 bg-[#FAFAFA] flex justify-between items-center w-full h-[70px] mx-auto px-4 shadow-md">
//         {/* Logo and Brand Name */}
//         <div className="flex items-center space-x-2">
//           <Image src="/logo.png" alt="Furniro Logo" width={50} height={32} />
//           <h1 className="text-2xl font-bold text-black">Furniro</h1>
...
//             </div>
//           </Link>
//           {/* Clerk User Button or Vector Icon */}
//           {isSignedIn ? (
//             <UserButton afterSignOutUrl="/" />
//           ) : (
//             <UserCircle size={30} className="text-gray-500 cursor-pointer" />
//           )}
//         </div>
...
//                   </Link>
//                 </div>
//                 {/* Clerk User Button or Vector Icon for Mobile */}
//                 <div className="mt-4">
//                   {isSignedIn ? (
//                     <UserButton afterSignOutUrl="/" />
//                   ) : (
...
import { useSelector } from "react-redux";
import { RootState } from "@/app/store/store";
import { useUser, UserButton, SignInButton, SignedIn, SignedOut } from "@clerk/nextjs"; // Import Clerk hooks and components
    ...
    <main>
      ...
      <div className="top-0 bg-[#FAFAFA] flex justify-between items-center w-full h-[70px] mx-auto px-4 shadow-md">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          {/* Clerk User Button or SignIn Button */}
          {isSignedIn ? (
            <UserButton afterSignOutUrl="/" />
          ) : (
            <SignInButton>
          ...
          <Sheet>
            ...
            <SheetContent side="right">
              ...
              <nav className="mt-4 space-y-4">
                ...
                {/* Clerk User Button or SignIn Button for Mobile */}
                <div className="mt-4">
                  {isSignedIn ? (
                    <UserButton afterSignOutUrl="/" />
                  ) : (
